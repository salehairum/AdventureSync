...
public class TouristManagesAccountView {
	...
	public void eventHandlersAssignment() {
		...
		updateLogo.setOnMouseClicked(createButtonHandler(TouristUpdatesAccountView.class, "Update Account"));
		updateLabel.setOnMouseClicked(createButtonHandler(TouristUpdatesAccountView.class, "Update Account"));
		deleteLogo.setOnMouseClicked(createButtonHandler(TouristDeletesAccountView.class, "Delete Account"));
		deleteLabel.setOnMouseClicked(createButtonHandler(TouristDeletesAccountView.class, "Delete Account"));
    }
