...
public class BusDriverMgrAccountView {
	...
	public BusDriverMgrAccountView(Integer bID) {
		busDriverID = bID;
    ...
    public void eventHandlersAssignment() {
        ...
        updateLogo.setOnMouseClicked(createButtonHandler(BusDriverUpdatesAccountView.class, "Update Account", busDriverID));
        updateLabel.setOnMouseClicked(createButtonHandler(BusDriverUpdatesAccountView.class, "Update Account", busDriverID));
        deleteLogo.setOnMouseClicked(createButtonHandler(BusDriverDeletesAccountView.class, "Delete Account", busDriverID));
        deleteLabel.setOnMouseClicked(createButtonHandler(BusDriverDeletesAccountView.class, "Delete Account", busDriverID));
