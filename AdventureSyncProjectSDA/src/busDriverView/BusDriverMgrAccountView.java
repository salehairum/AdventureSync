...
public class BusDriverMgrAccountView {
    ...
    public void eventHandlersAssignment() {
        ...
        updateLogo.setOnMouseClicked(createButtonHandler(BusDriverUpdatesAccountView.class, "Update Account"));
        updateLabel.setOnMouseClicked(createButtonHandler(BusDriverUpdatesAccountView.class, "Update Account"));
        deleteLogo.setOnMouseClicked(createButtonHandler(BusDriverDeletesAccountView.class, "Delete Account"));
        deleteLabel.setOnMouseClicked(createButtonHandler(BusDriverDeletesAccountView.class, "Delete Account"));
