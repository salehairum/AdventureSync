...
public class BusDriverUpdatesPasswordView {
	@FXML
	private Text name;
	@FXML
	private Text id;
	...
	public BusDriverUpdatesPasswordView(Integer id) {
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/busDriverView/busDriverUpdatePassword.fxml"));
	...
	public void eventHandlersAssignment() {	    
		EventHandler<ActionEvent> updateButtonHandler = (event) -> {
	        ...
	        ReturnObjectUtility<Integer> accountData=bdController.compareOldPassword(oldPassword, busDriverID);
	    ...
	    backButton.setOnMouseClicked(createButtonHandler(TouristManagesAccountView.class, "Manage Account", busDriverID));
    }
