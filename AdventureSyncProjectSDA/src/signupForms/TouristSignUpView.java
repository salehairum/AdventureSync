...
public class TouristSignUpView {
	...
	public TouristSignUpView() {
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/signupForms/touristSignup.fxml"));
	...
	public Tourist createTouristObject() {
	    ...
	    Tourist tourist = new Tourist(0, name, dob, cnic);
