...
public class TravelAgencyOwnerAssignsTourToBusView {
	...
	public TravelAgencyOwnerAssignsTourToBusView(Integer id) {
		tOwnerID = id;
	...
	public void eventHandlersAssignment() {
        ...
        viewBusButton.setOnMouseClicked(createButtonHandler(TravelAgencyViewBusesView.class, "View Buses", tOwnerID));
	}
