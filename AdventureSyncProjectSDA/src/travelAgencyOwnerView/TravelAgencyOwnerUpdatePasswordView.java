...
import touristView.TouristManagesAccountView;

public class TravelAgencyOwnerUpdatePasswordView {
	@FXML
	private Text name;
	@FXML
	private Text id;
	...
	public TravelAgencyOwnerUpdatePasswordView(Integer id) {
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/travelAgencyOwnerView/travelAgencyOwnerUpdatePassword.fxml"));
	...
	public void eventHandlersAssignment() {	    
		EventHandler<ActionEvent> updateButtonHandler = (event) -> {
	        ...
	        ReturnObjectUtility<Integer> accountData=taoController.compareOldPassword(oldPassword, tOwnerID);
	    ...
	    backButton.setOnMouseClicked(createButtonHandler(TouristManagesAccountView.class, "Manage Account", tOwnerID));
    }
