...
public class TravelAgencyOwnerViewCarsView {
	...
	public TravelAgencyOwnerViewCarsView(Integer id) {
		tOwnerID = id;
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/travelAgencyOwnerView/travelAgencyOwnerViewsCars.fxml"));
 ...
 // Method for button handling
    public void eventHandlersAssignment() {
    	...
    	updateButton.setOnMouseClicked(createButtonHandler(TravelAgencyUpdatesCarView.class, "Update Car", tOwnerID));
    	deleteButton.setOnMouseClicked(createButtonHandler(TravelAgencyDeleteCarsView.class, "Delete Car", tOwnerID));
        backButton.setOnMouseClicked(createButtonHandler(TravelAgencyManageCarsView.class, "Manage Car", tOwnerID));
    }
