...
public class HOMUpdateHotel {
    ...
    public void displayOwnerDetails() {
   	...
   	public void eventHandlersAssignment() {
        ...
        menuButton.setOnMouseClicked(createButtonHandler(HOMManageHotel.class, "Manage Hotel", hotelOwnerID));
        viewButton.setOnMouseClicked(createButtonHandler(HOMViewHotel.class, "View Hotel", hotelOwnerID));
    }
