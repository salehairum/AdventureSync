...
public class HotelOwnerUpdatesPasswordView {
	@FXML
	private Text name;
	@FXML
	private Text id;
	...
	public HotelOwnerUpdatesPasswordView(Integer id) {
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/hotelOwnerView/hotelOwnerUpdatePassword.fxml"));
	...
	public void eventHandlersAssignment() {	    
		EventHandler<ActionEvent> updateButtonHandler = (event) -> {
	        ...
	        ReturnObjectUtility<Integer> accountData=hoController.compareOldPassword(oldPassword, hotelOwnerID);
	        ...
	        ReturnObjectUtility<HotelOwner> returnData=hoController.updatePassword(password, hotelOwnerID);
