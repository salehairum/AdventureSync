...
public class BusDriverUpdateBusView {
    ...
    public void displayOwnerDetails() {
        String profileDetail[] = bController.getBusDriverProfileDetail(1);
	...
	public void eventHandlersAssignment() {
        ...
        viewButton.setOnMouseClicked(createButtonHandler(BusDriverViewBusDetailsView.class, "View Bus Detail"));
	}
